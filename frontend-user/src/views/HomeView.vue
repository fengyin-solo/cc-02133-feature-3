...
// 首页案例入口：点击后按同一行业标签口径跳转案例页并应用筛选
const goCaseIndustry = (caseItem) => {
  router.push({ path: '/cases', query: { tag: caseItem.tag } })
}
